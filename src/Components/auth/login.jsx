...
class Login extends Component {
    ...
    logIn = () => {
        ...
        .then(userInfo => {
            ...
            this.props.dispatch(loginUser({...userInfo.user, token: userInfo.jwt}))
    ...
    render() { 
        return ( 
            ...
            <div className="form sign-in">
                ...
                <button onClick={this.logIn} tabIndex="0" aria-label="Signin" className="submit">Sign In</button>
            ...
            <div className="sub-cont">
                ...
                <button tabIndex="0" aria-label="Signup" type="button" className="submit">Sign Up</button>
